...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("20/10/2023"), "Partiu viagen", "Vou viajar para São Paulo. Abraços!", maria);
        Post post2 = new Post(null, sdf.parse("19/10/2023"), "Bom dia", "Acordei feliz hoje!", maria);
